...
local arrow_left = {
   ...
   click = function()
      sep_arrow_left = sep_arrow_left == sep.right_filled and sep.right_rounded or sep.right_filled
   end,
}
...
local arrow_right = {
   ...
   click = function()
      sep_arrow_right = sep_arrow_right == sep.left_filled and sep.left_rounded or sep.left_filled
   end,
}
